    ...
    return (
        <div className="md:flex w-4/5 shadow-lg rounded-xl space-x-6 mx-auto space-y-6">
            ...
            <div className="space-y-4 my-auto pb-4">
                ...
                <h3 className="text-2xl ml-auto font-bold"> <span className="text-purple-600"></span> <i class="fas fa-play-circle text-purple-600"></i> {lesson} Classes Left</h3>
                <p>{details}</p>
                <button className="w-44 h-8 bg-purple-600 text-white rounded-md focus:ring-2 focus:bg-purple-600 hover:bg-purple-400">Start Now</button>
            </div>
        </div>
    );
};
